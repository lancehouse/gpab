 ...
 *
 * PROMOTED TO main/gpabs 2026-09-01 — this file's old separate-process
 * design (GPAB_LAUNCHER, kill_existing_gpab, on_gpab_exited,
 * show_launch_error) is gone; superseded entirely by py_embed.c on both
 * branches now. See ../../CLAUDE.md's "Branch and deployment rules" — the
 * worktree-specific divergence for gpab-stable now lives in py_embed.c's
 * GPAB_SITE_PACKAGES/GPAB_APP_ROOT instead of a #define in this file. */
