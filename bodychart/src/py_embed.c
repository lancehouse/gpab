 ...
 * These two paths differ per worktree, same shape as integration.c's old
 * GPAB_LAUNCHER divergence between dev and main — this is the gpab-stable/
 * main copy, promoted 2026-09-01, pointed at gpab-stable/assessment_gtk
 * rather than dev's own checkout (see CLAUDE.md's "Branch and deployment
 * rules"). */
#define GPAB_SITE_PACKAGES "/home/lance/Projects/gpab/gpab-stable/assessment_gtk/.venv/lib/python3.14/site-packages"
#define GPAB_APP_ROOT      "/home/lance/Projects/gpab/gpab-stable/assessment_gtk"
